...
java -jar $TRIM_HOME/trimmomatic.jar PE -threads 4 -phred33 ${READ1} ${READ2} ${OUTPUT}_R1_pe.fastq.gz ${OUTPUT}_R1_se.fastq.gz ${OUTPUT}_R2_pe.fastq.gz ${OUTPUT}_R2_se.fastq.gz ILLUMINACLIP:$TRIM_HOME/adapters/TruSeq3-PE.fa:2:30:10 LEADING:20 TRAILING:20 SLIDINGWINDOW:4:20 MINLEN:100

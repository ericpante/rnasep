...
blastp -query Trinity95_rnasep2_clean_min200.fasta.transdecoder_dir/longest_orfs.pep -db ${DATABASE} -out rnasep2_clean_TransDecoder_blastp.outfmt6 -evalue 1e-5 -num_threads 20 -max_target_seqs 1 -outfmt 6

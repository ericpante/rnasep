...
FASTA=Trinity_rnasep2.Trinity95.fasta
TRANS_MAP=Trinity_rnasep2.Trinity.fasta.gene_trans_map
...
awk 'NR==FNR {motifs[$1]; next} $2 in motifs' motifs_fasta_tmp.txt "$TRANS_MAP" > Trinity_rnasep2.Trinity95.fasta.gene_trans_map

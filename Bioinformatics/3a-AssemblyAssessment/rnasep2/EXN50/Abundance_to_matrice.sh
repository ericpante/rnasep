...
OUTPUT=rnasep2_assembly

abundance_estimates_to_matrix.pl --est_method kallisto --gene_trans_map Trinity_rnasep2.Trinity.fasta.gene_trans_map --out_prefix rnasep2\
